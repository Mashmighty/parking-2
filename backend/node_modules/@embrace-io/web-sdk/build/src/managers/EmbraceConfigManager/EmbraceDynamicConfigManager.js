...
class EmbraceDynamicConfigManager {
    constructor({ appID, appVersion, deviceId, diag: diagParam = api.diag.createComponentLogger({
    ...
    defaultConfig = {}, embraceConfigURL } = {}){
        ...
        if (appID && appVersion && deviceId) {
            this._remoteConfigURL = utils.getConfigURL(appID, {
                appVersion,
                deviceId,
    ...
    async refreshRemoteConfig() {
        ...
        try {
            ...
            this._storage.setItem(constants.LOCAL_STORAGE_REMOTE_CONFIG_KEY, JSON.stringify({
                config: remoteConfig,
                etag
            }));
    ...
    _getRemoteConfigFromStorage() {
        try {
            const configString = this._storage.getItem(constants.LOCAL_STORAGE_REMOTE_CONFIG_KEY);
            if (configString) {
...
exports.EmbraceDynamicConfigManager = EmbraceDynamicConfigManager;
