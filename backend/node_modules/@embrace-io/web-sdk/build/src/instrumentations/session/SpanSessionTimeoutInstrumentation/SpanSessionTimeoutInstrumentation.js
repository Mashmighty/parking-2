 ...
 **/ class SpanSessionTimeoutInstrumentation extends EmbraceInstrumentationBase.EmbraceInstrumentationBase {
    constructor({ diag, perf } = {}){
        super({
            ...
            this._sessionTimeout = setTimeout(this._checkTimeout, constants.TIMEOUT_TIME);
        }, this._checkTimeout = ()=>{
            ...
            if (currentSessionStartTime) {
                ...
                const remainingTime = constants.TIMEOUT_TIME - timePassed;
