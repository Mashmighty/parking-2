...
var appInstanceId = require('./appInstanceId.js');
var attributes = require('../constants/attributes.js');

const getWebSDKResource = ({ diagLogger, appVersion, templateBundleID, pageSessionStorage })=>{
  ...
  */ const processedAppVersion = appVersion ?? index.TEMPLATE_APP_VERSION.trim();
    return new resources.Resource({
        ...
        bundle_id: templateBundleID ?? index.TEMPLATE_BUNDLE_ID,
