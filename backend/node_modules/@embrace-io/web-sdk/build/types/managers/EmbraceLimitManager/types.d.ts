...
export type MaxLimitedType = LogLimitedType | 'span' | 'network_request' | 'breadcrumb' | 'session_property';
export type LengthLimitedType = LogLimitedType | 'breadcrumb' | 'session_property_key' | 'session_property_value' | 'log_attribute_key' | 'log_attribute_value';
