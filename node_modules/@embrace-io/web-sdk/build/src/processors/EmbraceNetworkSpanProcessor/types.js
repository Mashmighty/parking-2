...
const isNetworkSpan = (span)=>{
    ...
    span.attributes[semanticConventions.SEMATTRS_HTTP_METHOD]) && (span.attributes[semanticConventions.ATTR_HTTP_RESPONSE_STATUS_CODE] || // eslint-disable-next-line @typescript-eslint/no-deprecated
    span.attributes[semanticConventions.SEMATTRS_HTTP_STATUS_CODE])) {
