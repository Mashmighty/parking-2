...
import { KEY_PREFIX_EMB_PROPERTIES, KEY_EMB_STARTUP_DURATION, KEY_EMB_SESSION_REASON_ENDED, KEY_EMB_SESSION_NUMBER, KEY_EMB_COLD_START, KEY_EMB_STATE, EMB_STATES, EMB_TYPES, KEY_EMB_TYPE, KEY_EMB_SESSION_REASON_STARTED } from '../../constants/attributes.js';
...
class EmbraceSpanSessionManager {
    ...
    startSessionSpan(options) {
        ...
        this._sessionSpan = new EmbraceExtendedSpan(tracer.startSpan('emb-session', {
            attributes
        }));
