...
import { KEY_EMB_UNHANDLED_EXCEPTIONS_COUNT, EMB_TYPES, KEY_EMB_EXCEPTION_HANDLING, KEY_EMB_TYPE, KEY_EMB_ERROR_LOG_COUNT, KEY_EMB_JS_EXCEPTION_STACKTRACE } from '../../constants/attributes.js';
import { OTelPerformanceManager } from '../../utils/PerformanceManager/OTelPerformanceManager.js';

class EmbraceLogManager {
    constructor({ diag: diagParam, perf, spanSessionManager, limitManager }){
